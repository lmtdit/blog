...
这就要求前端开发安装后端的开发环境，以便控制map的合并、调试及迭代，但如果后端修改了业务逻辑或模板有修改，怎么知道新的业务所需的静态资源map是匹配的呢？而且，map的频繁更新会造成文件的合并冲突，解决冲突会给开发人员带来很多必须要的烦恼，这是很大的沟通成本。

在实际开发中，每次发新版前后端可能都要问前端，“你的静态资源map是不是最新的”，“你改的东西都上了没有”，等等。。。如果后端修改了模板，要发新版之前就要经过前端的确认与同意，他们一定很不爽。
